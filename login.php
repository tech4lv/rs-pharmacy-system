...
<head>
    ...
    <style>
        body { margin: 0; }
        .demo-creds { background: var(--gray-ultra); border-radius: var(--radius-sm); padding: 12px 16px; margin-bottom: 20px; font-size: 12px; }
        .demo-creds p { margin: 2px 0; color: var(--gray); }
        .demo-creds strong { color: var(--black); }
        .tab-btns { display: flex; border-bottom: 2px solid var(--gray-ultra); margin-bottom: 24px; }
        .tab-btn { flex: 1; padding: 10px; background: none; border: none; font-family: var(--font-body); font-size: 14px; font-weight: 600; color: var(--gray); cursor: pointer; transition: var(--transition); border-bottom: 2px solid transparent; margin-bottom: -2px; }
